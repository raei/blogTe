...
/*function category_exists($data){      
    $data = mysql_real_escape_string($data);    
    $query = mysql_query("SELECT COUNT(1) FROM categories  WHERE name = '{$data}'");//Testkod nedan
...
/*
 * Testkod category_exists
 * SELECT COUNT(1) FROM categories  WHERE id = 5;           // metod anrop från add_post
 * SELECT COUNT(1) FROM categories WHERE name = 'jula'     // metod anrop från add_category
 */